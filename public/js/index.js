$(document).ready(function() {
    ...
    $('.bigad .no1 .xianshui a').hover(function() {
        $('.bigad .no1 .xianshui a span').animate({
            left: '20px'
        }, 400);
    }, function() {
        $('.bigad .no1 .xianshui a span').animate({
    ...
    $('.bigad .shoping_inline .shopandphone a').hover(function() {
        $('.bigad .shoping_inline .shopandphone a span').animate({
            left: '20px'
        }, 400);
    }, function() {
        $('.bigad .shoping_inline .shopandphone a span').animate({
